...
const IMPORT_OPTIONS: ImportOption[] = [
    ...
    },
    {
        ...
        description: 'Thông tin liên hệ khách hàng, kể cả khách không có SĐT, phân loại, tags và công nợ đầu kỳ.',
        icon: Users,
        accent: 'text-pink-600 bg-pink-50 border-pink-200',
        columns: 'mã KH, tên KH, sdt/Zalo/Facebook, kênh chính, công nợ, chi tiêu',
    },
    {
        mode: 'supplier',
        title: 'Nhà cung cấp',
        description: 'Hồ sơ NCC và công nợ còn sót từ hệ thống cũ; không import phiếu nhập hàng lịch sử để tránh trùng tồn kho.',
        icon: Building2,
        accent: 'text-teal-600 bg-teal-50 border-teal-200',
        columns: 'mã NCC, tên NCC, sdt/Zalo/Facebook, ngân hàng, công nợ còn sót',
    },
    {
        mode: 'order',
        title: 'Đơn hàng lịch sử',
        description: 'Import đơn hàng từ hệ thống cũ để giữ khách hàng, doanh thu, bảo hành và công nợ; hỗ trợ Mã KH khi không có SĐT.',
        icon: ShoppingBag,
        accent: 'text-indigo-600 bg-indigo-50 border-indigo-200',
        columns: 'mã đơn, mã KH, khách hàng, sdt/Zalo/Facebook, tổng tiền, thanh toán',
    },
    {
        mode: 'repair',
        title: 'Phiếu sửa lịch sử',
        description: 'Import phiếu sửa đang tồn đọng hoặc đã hoàn thành để giữ lịch sử máy và bảo hành; hỗ trợ Mã KH khi không có SĐT.',
        icon: ClipboardList,
        accent: 'text-rose-600 bg-rose-50 border-rose-200',
        columns: 'mã phiếu, mã KH, khách hàng, thiết bị, lỗi, phí sửa, trạng thái',
    },
];
