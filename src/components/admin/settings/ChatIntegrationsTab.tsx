...
export default function ChatIntegrationsTab() {
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            <input title="Webhook URL" value={webhookUrls.facebook} readOnly className="flex-1 px-3 py-2 border rounded-lg bg-gray-50 text-sm" />
