...
export default function MissionsWidget() {
    ...
    if (!isOpen) {
        return (
            <button
                ...
                className="fixed bottom-6 left-6 z-50 bg-rose-600 text-white p-4 rounded-full shadow-xl hover:bg-rose-700 transition-transform hover:scale-110 flex items-center justify-center animate-bounce"
                title="Nhận quà tặng"
            >
    ...
    return (
        <div className="fixed bottom-6 left-6 z-50 w-80 bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col">
