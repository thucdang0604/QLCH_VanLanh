...
- **Severity:** high
- **Date:** 2026-06-12
- **Files:** `src/lib/repairWorkflowConfig.ts`, `src/lib/repairWorkflowServer.ts`, `src/app/api/repairs/transition/route.ts`, `src/app/admin/settings/repairs/page.tsx`
...
- Production hardening 2026-06-27: removed the one-time Firestore migration script from `scripts/` to prevent accidental re-run after go-live.
