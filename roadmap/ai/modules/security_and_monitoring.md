...
### Deferred 2026-06-30
- Lý do hoãn: Fix yêu cầu infrastructure change (OTP verification flow, SMS provider integration, frontend checkout redesign). Không thể thực hiện code-only fix.
- Giải pháp tạm thời có thể cân nhắc: rate-limit chặt cho checkout có voucher cá nhân + logging alert.
